...
int main() {
    ...
    while (true) {
        ...
        if (hdc) {
            ...
            int effectType = (int)(timeVal * 0.5f) % 6;
            ...
            case 3: {
                float scale = 1.0f + sin(timeVal * 2) * 0.1f;
